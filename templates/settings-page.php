...
<div class="wrap">
		        ...
		        <h2>Access keys for WPAjaxConnector</h2>
			<table>
				<tbody>
					<?php foreach($users as $data):?>
						<tr>
							<td><?php echo $data->user_login; ?></td>
							<td><input type="text" id="wpajaxconnector_access_key" name="wpajaxconnector_access_key" value="<?php echo str_repeat('*', 64); ?>" style="width: 600px" readonly/></td>
